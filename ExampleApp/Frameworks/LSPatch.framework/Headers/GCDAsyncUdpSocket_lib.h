...
**/
- (void)udpSocket:(GCDAsyncUdpSocket_lib *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(GCDAsyncUdpSocket_lib *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(GCDAsyncUdpSocket_lib *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(GCDAsyncUdpSocket_lib *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(GCDAsyncUdpSocket_lib *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(GCDAsyncUdpSocket_lib *)sock withError:(NSError  * _Nullable)error;
...
@interface GCDAsyncUdpSocket_lib : NSObject
